        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <tfoot>
              <tr>
                <td colspan="6">
                <form method="post" name="add_form" action="<%=basePath%>/back/news/addType">
               ...
               <tr>
                ...
                <td>
                 ...
                 <%--  <a href="<%=basePath%>/back/news/updateType?id=${bean.id}&type=${bean.type}" id="editButton" onclick="" title="修改"> --%>
                  ...
                  <a href="#" id="editButton" onclick="editType('<%=basePath%>/back/news/updateType',${bean.id});" title="修改">
                  <img src="<%=basePath %>/common/admin/images/icons/hammer_screwdriver.png" alt="Edit" /></a> 
                  <a href="<%=basePath%>/back/news/delType?typeId=${bean.id}" title="删除">
                  <img src="<%=basePath %>/common/admin/images/icons/cross.png" alt="Delete" /></a>
                  </td>
              </tr>
              </c:forEach>
