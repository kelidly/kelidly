...
<!--          <li><a href="#tab1" class="default-tab">管理列表</a></li>
	...
	function submitform(obj){
		...
		var url = "<%=basePath%>/back/productDemo/delMany";
...
<form action="<%=basePath%>/back/productDemo/pageQuery" id="pageForm_search" method="get">
            ...
            <form action=""  method="post" name="checkbox_Form" id="checkbox_Form" >
              <c:forEach var="bean"  varStatus="status" items="${pagemodel.result}"  >
               <tr>
                ...
                <td>${bean.name }</td>
                <td>${bean.url }</td>
                <td><img src="<%=basePath%>${bean.pic}">
               </td>
                <td>
                  <!-- Icons -->
                  <a href="<%=basePath%>/back/productDemo/updateView?demoId=${bean.id}" title="编辑"><img src="<%=basePath %>/common/admin/images/icons/pencil.png" alt="Edit" /></a> <a href="<%=basePath%>/back/productDemo/del?demoId=${bean.id}" title="删除"><img src="<%=basePath %>/common/admin/images/icons/cross.png" alt="Delete" /></a> <a href="#" title="设置"><img src="<%=basePath %>/common/admin/images/icons/hammer_screwdriver.png" alt="Edit Meta" /></a> </td>
              </tr>
              </c:forEach>
             </form>     
