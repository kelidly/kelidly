...
<!--          <li><a href="#tab1" class="default-tab">管理列表</a></li>
          <li><a href="<%=basePath %>/back/product/pub">发布文章</a></li>-->
        </ul>
        <div class="clear"></div>
      </div>
        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <tfoot>
              <tr>
                <td colspan="6">
                <form method="post" name="add_form" action="<%=basePath%>/back/product/addType">
              ...
              <c:forEach var="bean" items="${beanList}"  >
               <tr>
                ...
                <td>
                  ...
                  <a href="#" id="editButton" onclick="editType('<%=basePath%>/back/product/updateType',${bean.id});" title="修改">
                  <img src="<%=basePath %>/common/admin/images/icons/hammer_screwdriver.png" alt="Edit" />
                  </a> 
                  <a href="<%=basePath%>/back/product/delType?typeId=${bean.id}" title="删除">
