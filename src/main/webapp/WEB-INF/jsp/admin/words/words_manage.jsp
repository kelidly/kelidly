...
<!--          <li><a href="#tab1" class="default-tab">管理列表</a></li>
          <li><a href="<%=basePath %>/back/bean/pub">发布文章</a></li>-->
        </ul>
        <div class="clear"></div>
      </div>
	...
	function submitform(obj){
		...
		var url = "<%=basePath%>/back/words/delMany";
...
<form action="<%=basePath%>/back/words/pageQuery" id="pageForm_search" method="get">
            ...
            <form action=""  method="post" name="checkbox_Form" id="checkbox_Form" >
              <c:forEach var="bean"  varStatus="status" items="${pagemodel.result}"  >
               <tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="<%=basePath%>/back/words/updateView?wordsId=${bean.id}" title="编辑"><img src="<%=basePath %>/common/admin/images/icons/pencil.png" alt="Edit" /></a> <a href="<%=basePath%>/back/words/del?wordsId=${bean.id}" title="删除"><img src="<%=basePath %>/common/admin/images/icons/cross.png" alt="Delete" /></a> <a href="#" title="设置"><img src="<%=basePath %>/common/admin/images/icons/hammer_screwdriver.png" alt="Edit Meta" /></a> </td>
              </tr>
              </c:forEach>
             </form>     
