...
<li><A href='<%=basePath %>/product/index?typeId=${bean.id}'>${bean.type}</A></li> 
</c:forEach>
</ul>
</div>
</div>
...
<div class="content">
    ...
    <c:forEach items="${usebeanList}" var="usebean">
            <div class="MorePro">
              <div class="CaseBlock">
                <ul>
                  <ul> 
                    ...
                    <div class='albumblock'>
                      <div class='inner'><a href='<%=basePath%>/product/show?useId=${usebean.id}' target='_blank'  title='${usebean.name}'><img src='<%=basePath%>/${usebean.img}' />
                    ...
                    <table> 
                     ...
                     <tr> 
                    <td><br><h3>${usebean.name}</h3></td>
                    </tr>
                     <tr> 
                    <td><br>${usebean.content}
                     </td>
                    </tr>
                    <tr> 
                    <td><br></br>
                      <a href="<%=basePath%>/product/show?useId=${usebean.id}">阅读全文</a></td>
                    </tr>
                    </table>     
                  </ul>
