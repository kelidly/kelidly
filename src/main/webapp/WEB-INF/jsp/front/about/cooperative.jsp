...
<li class='current'><A href='<%=basePath%>/about/cooperative'>合作推广</A></li> 
...
<!--right start-->
<div class="right">
<div class="Position"><span>你的位置：<a href="/">首页</a> > <a href='/About/'>关于公司</a> > <a href='/About/intro/'>${aboutBean.title}</a></span></div>
<div class="HeightTab clearfix"></div>
<!--main start-->
<div class="main">
