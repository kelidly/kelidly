...
String.prototype.endsWith = function(str) {
    ...
    var QLogin = {
        ...
        createLoginArea: function() {
            ...
            var $loginArea = $('<div id="udbsdk_login_normal" width="800px" height="800px" class="udbsdk_login">' + '<embed src="swf1/desktop3dshow.swf" style="width:1000px; height:800px;" allowfullscreen="true" quality="high" allowscriptaccess="always" type="application/x-shockwave-flash" align="middle">' + '</div>');
        ...
        ajaxOpenWithSaveToken: function(wakeLoginURL, callbackURL, denyCallbackURL) {

        
                  //  QLogin.writeCookie("udboauthtmptokensec", data.ttokensec, document.domain, "/");
                    QLogin.open("http://localhost:8081/huixin/productDemo/detail?id=7&typeId=1&useId=2");
