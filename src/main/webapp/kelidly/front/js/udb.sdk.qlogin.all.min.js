...
/*    	<object id="myId" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="300" height="140">
        ...
        createLoginArea: function() {
            ...
            var $loginArea = $('<div id="udbsdk_login_normal"  class="udbsdk_login">' 
            		+ '<object id="swfobjectid" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="300" height="140">' 
            		+ '<param name="movie" id="swfid" value="test.swf" id="swfid" /> <!--[if !IE]>-->'
            		+ '<object type="application/x-shockwave-flash" data="test.swf" width="300" height="140"> <!--<![endif]-->'
            		+'<!--[if !IE]>--> <!--[if !IE]>--> </object> <!--<![endif]--> </object>' </div>');
